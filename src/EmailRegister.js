                                        ...
                                        <div className="p-5">
                                            <div className="row text-center" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', margin: 0 }}>
                                                <div className="col-lg-8">
                                                    ...
                                                    <h1 className="h5 text-gray-900 mb-4" style={{ margin: 0 }}>Email Registration</h1>
                                                    <p className="text-gray-100 mb-4" style={{ margin: 0 }}>Lets get started, fill in your details and click <b>Register button</b></p>
                                                </div>
                                            </div>
