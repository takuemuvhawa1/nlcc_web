const About = () => {
    return (
        <div>
            <h4 style={{textAlign: 'center', fontSize: '19px', color: '#1a6363'}}>About New Life Covenant Church</h4>
            <div class="block">
                <h5 style={{fontSize: '18px', marginTop: '18px'}}>Who we are and what we believe in</h5>
            ...
            <div class="block">
                <h5 style={{fontSize: '18px'}}>A place to belong</h5>
